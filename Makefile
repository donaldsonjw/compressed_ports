...
BLDFLAGS_COMMON = -lz -lzstd -llzma -lbz2 -llz4 
...
release_jbins: release_zips $(RELEASE_JBINS) $(BUILD_LIB_DIR)/xz-1.9.jar $(BUILD_LIB_DIR)/zstd-jni-1.5.5-4.jar $(BUILD_LIB_DIR)/bzip2-0.9.1.jar $(BUILD_LIB_DIR)/lz4-pure-java-1.8.0.jar

unsafe_jbins: $(BUILD_LIB_DIR)/zstd-jni-1.5.5-4.jar $(BUILD_LIB_DIR)/xz-1.9.jar $(UNSAFE_JBINS) $(BUILD_LIB_DIR)/bzip2-0.9.1.jar $(BUILD_LIB_DIR)/lz4-pure-java-1.8.0.jar
...
release_zips: $(BUILD_LIB_DIR)/zstd-jni-1.5.5-4.jar $(BUILD_LIB_DIR)/xz-1.9.jar $(BUILD_LIB_DIR)/bzip2-0.9.1.jar $(BUILD_LIB_DIR)/lz4-pure-java-1.8.0.jar $(RELEASE_ZIPS) 

test_bins: $(TEST_BINS) 

test_jbins: $(BUILD_LIB_DIR)/zstd-jni-1.5.5-4.jar $(BUILD_LIB_DIR)/xz-1.9.jar $(BUILD_LIB_DIR)/bzip2-0.9.1.jar $(BUILD_LIB_DIR)/lz4-pure-java-1.8.0.jar $(TEST_JBINS)  
...
test_jvm: $(TEST_JBINS) $(BUILD_LIB_DIR)/zstd-jni-1.5.5-4.jar $(BUILD_LIB_DIR)/xz-1.9.jar $(BUILD_LIB_DIR)/bzip2-0.9.1.jar $(BUILD_LIB_DIR)/lz4-pure-java-1.8.0.jar
...
$(BUILD_LIB_DIR)/lz4-pure-java-1.8.0.jar:
	@($(MAVEN) -q dependency:get -Ddest="$(@D)" -Dartifact=org.lz4:lz4-pure-java:1.8.0)
